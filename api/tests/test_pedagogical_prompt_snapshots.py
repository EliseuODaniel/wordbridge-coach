    ...
    assert messages == [
        {
            ...
            "content": (
                ...
                "- teacher_summary, strengths, focus_areas, reflection_question, encouragement, "
                "and corrections[].why must be in Portuguese.\n"
                "- rewrite, corrections[].mistake, corrections[].fix, and next_practice must stay in English.\n"
