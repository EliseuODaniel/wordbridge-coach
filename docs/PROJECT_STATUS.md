...
2. Continuar a extração do Chat Coach, agora avaliando se o próximo corte deve separar o bloco REST/serialização do endpoint ou endurecer mais a cobertura de integração do fluxo completo.
